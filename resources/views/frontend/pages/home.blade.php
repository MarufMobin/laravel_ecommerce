                ...
                <div class="container-fluid">
                  <div class="caption bg-color vertical-center text-left">
                    ...
                    <div class="button-holder fadeInDown-3"> 
                      <a href="{{ $slider->button_url }}" class="btn-lg btn btn-uppercase btn-primary shop-now-button">{{ $slider->button_text }}</a> </div>
                  </div>
                </div>
              </div>
            @endforeach
                ...
                <div class="owl-carousel home-owl-carousel custom-carousel owl-theme" data-item="4">
                  ...
                  <div class="item item-carousel">
                    <div class="products">
                      <div class="product">
                        <div class="product-image">
                          <div class="image"> <a href="detail.html"><img src="{{ asset('frontend\assets\images\products\p4.jp') }}g" alt=""></a> </div>
                          <!-- /.image -->
                      ...
                      <div class="product-image">
                        ...
                        @else 
                          ...
                          @else if( $value->product_type == 1 )
                            <div class="tag hot"><span>pre owned</span></div>
                          @endif 
                        @endif 
