                ...
                <div class="container-fluid">
                    <div class="caption bg-color vertical-center text-left">
                        ...
                        <div class="button-holder fadeInDown-3">
                            <a href="{{ $slider->button_url }}" class="btn-lg btn btn-uppercase btn-primary shop-now-button">{{ $slider->button_text }}</a>
                        </div>
                    </div>
                </div>
            </div>
                          ...
                          <div class="product">
                            ...
                            <div class="product-info text-left">
                              ...
                              @if( !is_null( $value->offer_price ) )
                                ...
                                <span class="price-before-discount"> ৳ {{ $value->regular_price }}</span> </div>
                              @else
                        ...
                        <div class="item item-carousel">
                            <div class="products">
                                <div class="product">
                                    <div class="product-image">
                                        <div class="image">
                                            <a href="detail.html"><img src="{{ asset('frontend\assets\images\products\p7.jpg') }}" alt="" /></a>
                                        </div>
                                        <!-- /.image -->
                        ...
                        <div class="item item-carousel">
                            <div class="products">
                                <div class="product">
                                    <div class="product-image">
                                        <div class="image">
                                            <a href="detail.html"><img src="{{ asset('frontend\assets\images\products\p8.jpg') }}" alt="" /></a>
                                        </div>
                                        <!-- /.image -->
                        ...
                        <div class="item item-carousel">
                            <div class="products">
                                <div class="product">
                                    <div class="product-image">
                                        <div class="image">
                                            <a href="detail.html"><img src="{{ asset('frontend\assets\images\products\p9.jpg') }}" alt="" /></a>
                                        </div>
                                        <!-- /.image -->
                        ...
                        <div class="item item-carousel">
                            <div class="products">
                                <div class="product">
                                    <div class="product-image">
                                        <div class="image">
                                            <a href="detail.html"><img src="{{ asset('frontend\assets\images\products\p10.jpg') }}" alt="" /></a>
                                        </div>
                                        <!-- /.image -->
                        ...
                        <div class="item item-carousel">
                            <div class="products">
                                <div class="product">
                                    <div class="product-image">
                                        <div class="image">
                                            <a href="detail.html"><img src="{{ asset('frontend\assets\images\products\p11.jpg') }}" alt="" /></a>
                                        </div>
                                        <!-- /.image -->
                        ...
                        <div class="item item-carousel">
                            <div class="products">
                                <div class="product">
                                    <div class="product-image">
                                        <div class="image">
                                            <a href="detail.html"><img src="{{ asset('frontend\assets\images\products\p12.jpg') }}" alt="" /></a>
                                        </div>
                                        <!-- /.image -->
                        ...
                        <div class="item item-carousel">
                            <div class="products">
                                <div class="product">
                                    <div class="product-image">
                                        <div class="image">
                                            <a href="detail.html"><img src="{{ asset('frontend\assets\images\products\p13.jpg') }}" alt="" /></a>
                                        </div>
                                        <!-- /.image -->
                        ...
                        <div class="item item-carousel">
                            <div class="products">
                                <div class="product">
                                    <div class="product-image">
                                        <div class="image">
                                            <a href="detail.html"><img src="{{ asset('frontend\assets\images\products\p14.jpg') }}" alt="" /></a>
                                        </div>
                                        <!-- /.image -->
                        ...
                        <div class="item item-carousel">
                            <div class="products">
                                <div class="product">
                                    <div class="product-image">
                                        <div class="image">
                                            <a href="detail.html"><img src="{{ asset('frontend\assets\images\products\p15.jpg') }}" alt="image" /></a>
                                        </div>
                                        <!-- /.image -->
                        ...
                        <div class="item item-carousel">
                            <div class="products">
                                <div class="product">
                                    <div class="product-image">
                                        <div class="image">
                                            <a href="detail.html"><img src="{{ asset('frontend\assets\images\products\p16.jpg') }}" alt="" /></a>
                                        </div>
                                        <!-- /.image -->
                        ...
                        <div class="item item-carousel">
                            <div class="products">
                                <div class="product">
                                    <div class="product-image">
                                        <div class="image">
                                            <a href="detail.html"><img src="{{ asset('frontend\assets\images\products\p18.jpg') }}" alt="" /></a>
                                        </div>
                                        <!-- /.image -->
                        ...
                        <div class="item item-carousel">
                            <div class="products">
                                <div class="product">
                                    <div class="product-image">
                                        <div class="image">
                                            <a href="detail.html"><img src="{{ asset('frontend\assets\images\products\p17.jpg') }}" alt="" /></a>
                                        </div>
                                        <!-- /.image -->
