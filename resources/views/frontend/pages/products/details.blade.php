                        ...
                        <div class="owl-wrapper-outer">
                            <div class="owl-wrapper" style="width: 5742px; left: 0px; display: block;">
                                ...
                                @else
                                    <div class="owl-item" style="width: 319px;">
                                        <div class="single-product-gallery-item" id="slide1">
                                            <a data-lightbox="image-1" data-title="Gallery" href="{{ asset('Backend/img/product/default.png' ) }}">
                                                <img class="img-responsive" alt="" src="{{ asset('Backend/img/product/default.png' ) }}" />
                                            </a>
                                        </div>
                                    </div>
                                @endif 
                ...
                <div class="product-info">
                    ...
                    <div class="stock-container info-container m-t-10">
                        <div class="row">
                            <div class="col-sm-2">
                                <div class="stock-box">
                                    <span class="label ml-5">Availability : </span>
                                </div>
                            </div>
                            <div class="col-sm-9">
                                <div class="stock-box">
                                    ...
                                    @else
                                        <span class="value">  {{ $value->quentity }} PCS - In Stock</span>
                                    @endif 
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="price-box">
                                    ...
                                    @else
                                        <span class="price-strike">৳ {{$value->offer_price}}</span>
                                    @endif
                                </div>
                            </div>
