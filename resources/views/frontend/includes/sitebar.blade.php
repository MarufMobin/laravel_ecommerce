    ...
    <div class="col-xs-12 col-sm-12 col-md-3 sidebar"> 
          ...
          <nav class="yamm megamenu-horizontal">
            <ul class="nav">
             ...
             @foreach( App\Models\Backend\Category::orderBy('name', 'asc')->where('is_parent', 0)->get() as $parentCategory )
                ...
                <li class="dropdown menu-item"> <a href="#" class="dropdown-toggle" data-toggle="dropdown"><i class="{{ $parentCategory->icon_class }}" aria-hidden="true"></i>{{ $parentCategory->name }}</a> 
                  <!-- ================================== MEGAMENU VERTICAL ================================== -->
                  ...
                  <div class="product">
                    <div class="product-micro">
                      <div class="row product-micro-row">
                        <div class="col col-xs-5">
                          <div class="product-image">
                            <div class="image"> <a href="#"> <img src="{{ asset('frontend\assets\images\products\p28.jp') }}g" alt=""> </a> </div>
                            <!-- /.image --> 
        ...
        <div class="sidebar-widget  wow fadeInUp outer-top-vs ">
          <div id="advertisement" class="advertisement">
            <div class="item">
              <div class="avatar"><img src="{{ asset('frontend\assets\images\testimonials\member1.png') }}" alt="Image"></div>
            ...
            <div class="item">
              <div class="avatar"><img src="{{ asset('frontend\assets\images\testimonials\member2.png') }}" alt="Image"></div>
              <div class="testimonials"><em>"</em> Vtae sodales aliq uam morbi non sem lacus port mollis. Nunc condime tum metus eud molest sed consectetuer.<em>"</em></div>
